import { IsString, IsInt, IsOptional, IsBoolean, IsNotEmpty, Matches, Length } from 'class-validator';
...
export class CreateVeicoloDto {
  ...
  @Matches(/^[A-Z]{2}[0-9]{3}[A-Z]{2}$/, { message: 'Formato targa non valido (es. AA123BB)' })
  targa!: string;
